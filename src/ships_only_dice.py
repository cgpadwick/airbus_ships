...
tb_callback = TensorBoard(log_dir='./log_dice', histogram_freq=0,  
...
model.compile(optimizer=Adam(1e-3, decay=0.0), loss=dice_loss, metrics=['binary_accuracy'])
...
model.save('seg_model_hypercolumn_ships_only_dice.h5')
